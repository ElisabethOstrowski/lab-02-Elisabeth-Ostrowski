...
source, console, environment/history, and files/plots/packages/help
...
North America stands out as having a higher per capita waste generation compared to other continents. 
...
Color and fill are defined by mapping aesthetics because they are used to differentiate and visualize data points and groups. Alpha level is characterized by plotting geom because it controls the visual appearance of the geom. 
...
The violin plot reveals the entire distribution of the data. The box plot will show a summary and the outliers more directly.
...
The ratio of mismanaged plastic and plastic waste is almost the same. 
...
There does not seem to be any clear distinction. 
...
The distribution seems very similar but there are more outliers in the coastal population graph. 
